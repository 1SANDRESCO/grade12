...
int getRangeNumber(string s) {
    int x;
    cout << "Enter " << s << " number for number: ";
    scanf("%i", &x);
    return x;
}
...
//        return "Whiskey: { Name: " + this->name + ", Distillery: " + this->distillery + ", Year Made: " + this->yearMade + ", Cost: " + this->cost; + ", Size: " + this->size + ", Canadian?" + this->canadian;
        //string a = to_string(444);
        return "Whiskey: { Name: " + this->name + ", Distillery: " + this->distillery; //+ ", Year Made: " + a;// + ", Cost: " + this->cost; + ", Size: " + this->size + ", Canadian?" + this->canadian;
