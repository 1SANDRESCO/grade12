...
public class Stack implements StackInterface {
    ...
    public int top() {
        if (!isEmpty()) {
            ...
            System.out.println("Is empty cannot return top");
        }
        return -1;
    ...
    public int pop() {
        if (!isEmpty()) {
            x = data[top];
            data[top] = -1;
            System.out.println("Pop: Data at top (index " + top + ") was " + x);
            top--;
    ...
    public static void main(String[] args) {
        ...
        Stack s = new Stack(4);
        s.displayArray();
        System.out.println("E: " + s.isEmpty());
        System.out.println("F: " + s.isFull());
        s.push(-11);
        s.push(22);
        s.push(-33);
        s.push(44);
